...
void SherlockHolmes :: initial_deck(){
    cards.deck.push_back(Card(CardName::Administer_Aid, CardTiming::Immediate, CardType :: EVENT , Usertype :: DR_WATSON , 0, 0, 2 , Make_Effect({new ReplaceEffect(1) , new HealEffect(1) , new DrawCardEffect(1)})));
    cards.deck.push_back(Card(CardName::Administer_Aid, CardTiming::Immediate, CardType :: EVENT , Usertype :: DR_WATSON , 0, 0, 2 , Make_Effect({new ReplaceEffect(1) , new HealEffect(1) , new DrawCardEffect(1)})));
    ...
    cards.deck.push_back(Card(CardName::Deduce_Strategy, CardTiming::During, CardType :: BOTH , Usertype :: HOLMES , 3, 3, 1 , Make_Effect({})));
    cards.deck.push_back(Card(CardName::Deduce_Strategy, CardTiming::During, CardType :: BOTH , Usertype :: HOLMES , 3, 3, 1 , Make_Effect({})));
    cards.deck.push_back(Card(CardName::Deduce_Strategy, CardTiming::During, CardType :: BOTH , Usertype :: HOLMES , 3, 3, 1 , Make_Effect({})));
    ...
    cards.deck.push_back(Card(CardName::The_Game_Is_Afoot, CardTiming::After, CardType :: ATTACK, Usertype :: HOLMES , 0, 5, 2 , Make_Effect({new Move(3)})));
    cards.deck.push_back(Card(CardName::The_Game_Is_Afoot, CardTiming::After, CardType :: ATTACK, Usertype :: HOLMES , 0, 5, 2 , Make_Effect({new Move(3)})));

    cards.deck.push_back(Card(CardName::Service_Revolver, CardTiming::Immediate, CardType :: ATTACK, Usertype :: DR_WATSON , 0 , 5, 2 , Make_Effect({})));
    cards.deck.push_back(Card(CardName::Service_Revolver, CardTiming::Immediate, CardType :: ATTACK, Usertype :: DR_WATSON , 0 , 5, 2 , Make_Effect({})));
